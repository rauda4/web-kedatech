...
2; // Fungsi untuk mengurutkan angka dari kecil ke besar
...
console.log('tidak enak', isPalindrome('tidak enak')); // false
console.log('auda adua', isPalindrome('auda adua')); // true
